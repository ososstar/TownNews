...
public class SettingsActivity extends AppCompatActivity {
    ...
    public static class TownNewsPreferenceFragment extends PreferenceFragment
        ...
        public void onCreate(Bundle savedInstanceState) {
            ...
            Preference maxResults = findPreference(getString(R.string.settings_number_of_results_key));
